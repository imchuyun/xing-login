...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .pay-amount { font-size: 2rem; font-weight: 700; color: #12b7f5; margin-bottom: 1.5rem; }
        ...
        .pay-status.success { background: #e6f7ff; color: #12b7f5; }
        .btn { display: inline-block; padding: 0.75rem 1.5rem; background: #12b7f5; color: #fff; border: none; border-radius: 0.5rem; font-size: 1rem; cursor: pointer; text-decoration: none; margin-top: 1rem; }
...
<body>
    <div class="pay-card">
        <img src="/assets/icon/qq.svg" alt="QQ钱包" class="pay-logo">
        <h1 class="pay-title">QQ钱包扫码支付</h1>
        ...
        <p class="pay-tip">请使用QQ扫描二维码完成支付</p>
