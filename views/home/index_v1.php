...
<section class="hero-section" id="hero-section">
    ...
    <div class="hero-content">
        ...
        <div class="hero-buttons animate-appear delay-300">
            ...
            <a href="/user/docs" class="btn btn-outline">
...
<section class="providers-section">
    ...
    <div class="providers-grid">
        <div class="provider-icon" title="QQ">
            <img src="/assets/icon/qq.svg" alt="QQ" style="width: 1.5rem; height: 1.5rem;">
        </div>
        <div class="provider-icon" title="微信">
            <img src="/assets/icon/wx.svg" alt="微信" style="width: 1.5rem; height: 1.5rem;">
        </div>
        <div class="provider-icon" title="支付宝">
            <img src="/assets/icon/alipay.svg" alt="支付宝" style="width: 1.5rem; height: 1.5rem;">
        </div>
        <div class="provider-icon" title="微博">
            <img src="/assets/icon/sina.svg" alt="微博" style="width: 1.5rem; height: 1.5rem;">
        </div>
        <div class="provider-icon" title="GitHub">
            <img src="/assets/icon/github.svg" alt="GitHub" style="width: 1.5rem; height: 1.5rem;">
        </div>
        <div class="provider-icon" title="Google">
            <img src="/assets/icon/google.svg" alt="Google" style="width: 1.5rem; height: 1.5rem;">
        </div>
        <div class="provider-icon" title="Gitee">
            <img src="/assets/icon/gitee.svg" alt="Gitee" style="width: 1.5rem; height: 1.5rem;">
        </div>
        <div class="provider-icon" title="百度">
            <img src="/assets/icon/baidu.svg" alt="百度" style="width: 1.5rem; height: 1.5rem;">
        </div>
    </div>
</section>
...
<section class="cta-section">
    ...
    <div class="cta-buttons">
        ...
        <a href="/user/products" class="btn btn-outline" style="padding: 0.875rem 2.5rem; font-size: 1rem;">
            私有部署咨询
        </a>
    </div>
</section>
